    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          That route is not part of the discovery graph.
        </p>
        <div className="mt-6">
          <Link
            to="/"
  ...
  head: () => ({
    meta: [
      ...
      { title: "Discovery OS — Evidence-backed scientific discovery" },
      {
        name: "description",
        content:
          "A research-grade discovery engine for biomedical questions, built on legal open data: OpenAlex, PubMed, Europe PMC, ChEMBL, ClinicalTrials.gov, RCSB PDB.",
      },
      { property: "og:title", content: "Discovery OS" },
      { property: "og:description", content: "Evidence-backed discovery from open scientific data." },
